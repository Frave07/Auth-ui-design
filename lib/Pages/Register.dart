          ...
          children: [
            ...
            Stack(
              children: [
                ...
                ButtonLeft(texto: 'SIGN IN', top: 160, left: -25, check: false, onPressed: () => Navigator.pushReplacementNamed(context, 'login')),

                ButtonLeft(texto: 'SIGN UP', top: 300, left: -20 ),

                ButtonLeft(texto: 'FORGOT PASSWORD', top: 500, left: -83, check: false ),
                ...
                _CajaTexto(titulo: 'Your Name', icono: Icons.person_outline, isPassword: false ,top: 220),

                _CajaTexto(titulo: 'Email Address', icono: Icons.email_outlined, isPassword: false, top: 290),
                
                _CajaTexto(titulo: 'Password', icono: Icons.lock, isPassword: true, top: 360),
                ...
                Positioned(
                  top: 520,
                  left: 150,
                  child: Text('Or sign up with', style: TextStyle(color: Colors.black, fontSize: 20))
                ),
